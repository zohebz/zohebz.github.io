class Project {
    ...
    div() {
        ...
        div.innerHTML = `
            ...
            <div class="project-desc style="display:flex"> 
                ${this.description}
            </div>
...
const projects = [
    {
        title: "Animation",
        desc: '<iframe src="https://drive.google.com/file/d/1YtgUVy5__FdF-bvOEYnyDIUbDjouETEO/preview" allow="autoplay" width="250" height="160"></iframe> <a href="https://zohebz.github.io/animations.html">More >></a>.',
